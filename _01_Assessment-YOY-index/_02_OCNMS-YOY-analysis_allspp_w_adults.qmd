...
## Make yoy rockfish time-series plots
 yoy.ts <- ggplot() + 
   ...
   #               width=0,
   #               color="blue",size=1.2) +
   geom_ribbon(data=df_yoy, aes(year, ymin=q025, ymax=q975), fill='blue',alpha=0.1) +
...
ggsave( paste0(fig_dir, "ocnms-rockfish-yoy-modeled.png"), units='in',
        width = 3.5, height = 7)
ggsave( "~/GitHub/ESR-rockfish-yoy/figures/ocnms-rockfish-yoy-modeled.png", units='in',
        width = 3.5, height = 7) 
