...
df_yoy$complex = factor(df_yoy$complex, levels = c('YTB','SEPI','SEMY','CQB','SENE','RYOY')) 
dat.yoy.summary$complex = factor(dat.yoy.summary$complex, levels = c('YTB','SEPI','SEMY','CQB','SENE','RYOY')) 
