...
# write.csv(esr_yoy, "~/Github/ESR-Figures-Code/Data/GF-ocnms-rockfish-yoy_2026.csv", row.names = F )
```
...
# write.csv(esr_fish, "~/Github/ESR-Figures-Code/Data/GF-ocnms-fish-adults_2026.csv", row.names = F )
