...
# upc_out = paste0(data_dir,'NWFSC_UPC_ALLYEARS_data_',data_year,'.xlsm')

# download
drive_download( as_id(fish_id) , path = fish_out, overwrite = TRUE)
# drive_download( as_id(swath_id) , path = swath_out , overwrite = TRUE)
# drive_download( as_id(upc_id) , path = upc_out, overwrite = TRUE)

# convert to csv
fishxl = data.frame(read_xlsx(paste0(data_dir,'NWFSC_FISH_ALLYEARS_data_',data_year,'.xlsm'),
                   sheet = 'DATA'))
# swathxl = data.frame(read_xlsx(paste0(data_dir,'NWFSC_SWATH_ALLYEARS_data_',data_year,'.xlsm'),
 #                              sheet = 'data'))
# upcxl = data.frame(read_xlsx(paste0(data_dir,'NWFSC_UPC_ALLYEARS_data_',data_year,'.xlsm'),
   #                           sheet = 'DATA'))
...
# write.csv(upcxl, paste0(data_dir,'NWFSC_UPC_ALLYEARS_data_',data_year,'.csv'), row.names = F)
...
write.csv(fish_transect, paste0(data_dir,'Summarized_Data_Fish_by_Transect.rds'))
