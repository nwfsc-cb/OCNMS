...
# convert to csv
swathxl = data.frame(read_xlsx(paste0(data_dir,'NWFSC_SWATH_ALLYEARS_data_',data_year,'.xlsm'),  sheet = 'data'))

write.csv(swathxl, paste0(data_dir,'NWFSC_SWATH_ALLYEARS_data_',data_year,'.csv'), row.names = F)
