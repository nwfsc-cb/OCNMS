...
write.csv(p_out, '~/GitHub/NMS-condition-reports/data/OCNMS-total-pycno.csv', row.names = F)
...
write.csv(df_out, "~/GitHub/NMS-condition-reports/data/OCNMS-pynopodia.csv", row.names = F)
...
ggplot(df %>% filter(species=="PYCHEL"), aes(year, mn, color=site)) +
 ...
 write.csv(df_out, "~/GitHub/NMS-condition-reports/data/OCNMS-pynopodia-site.csv", row.names = F)
...
# write.csv("~/GitHub/NMS-condition-reports/data/OCNMS-pynopodia.csv", row.names = F)
...
write.csv(stars_out, "~/GitHub/NMS-condition-reports/data/OCNMS-seastars.csv", row.names = F)
