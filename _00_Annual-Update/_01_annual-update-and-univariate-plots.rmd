...
write.csv(esr_yoy, "~/GitHub/NMS-condition-reports/data/ocnms-dive-fish-yoy.csv", row.names = F)
...
# ocnms condition report
write.csv(esr_fish, "~/GitHub/NMS-condition-reports/data/ocnms-dive-fish-adults.csv", row.names = F)
...
kw = data.frame(read.csv("~/GitHub/OCNMS/Data/Kelp/kelp-west-coast.csv"))
