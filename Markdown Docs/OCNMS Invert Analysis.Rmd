...
These are some analyses based on the 2015-19 survey data for invertebrates. I've done a bunch of processing in the Git repo (file "/GitHub/OCNMS/R scripts/Fish, Invert, Kelp Analysis/Swath Inverts.R"").
