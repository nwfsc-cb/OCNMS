...
dat.invert$grp2[dat.invert$taxa %in% c('Pisaster','Pynopodia')] <- 'STAR'
...
```{r Figure-2_3Combined, fig.width=6, fig.height=6}

# library(ggpubr)


ggarrange(
  kelp_coast5, urchin.plot, stars_year, fish.plot,yoy.plot,
  labels = c('a)','b)','c)','d)', 'e)'), 
  # labels = 'auto',
  font.label = list(face='plain', size = 10),
  hjust = -6,
