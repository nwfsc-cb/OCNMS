...
# choose depth to analyze for nMDS and CAPdiscrim

kelp.depth = c(5,10)
fish.depth = c(5,10)
invert.depth = c(5,10)

if(length(kelp.depth == 2)){kelp_depth = "_5n10-m"}else{kelp_depth = paste0('_',kelp.depth,"-m")}
if(length(fish.depth == 2)){fish_depth = "_5n10-m"}else{fish_depth = paste0('_',fish.depth,"-m")}
if(length(invert.depth == 2)){invert_depth = "_5n10-m"}else{invert_depth = paste0('_',invert.depth,"-m")}
...
non-metric MDS just to have a look. Kind of ugly. No aliby  
...
Fish included were `r fish.spp`

Years included were `r levels(as.factor(df0$year))`
