...
relief.plot <- ggplot(relief_site,aes(x=ZONE)) +
...
# substrate plot ####
substrate.plot <- ggplot(substrate_site,aes(x=ZONE)) +
...
jpeg( paste0(Fig_Loc,'Substrate-Tatoosh.jpg'), res=300, units='in', height = 4, width = 5)
ggarrange(
