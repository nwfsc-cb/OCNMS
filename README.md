...
(1) 'settings.r' has multiple settings and other common info across main files like: minimuml visibility, a common ggplot theme for figures, code to run some other source files, etc.
